...
```
Core (P1-P13):      [███░░░░░░░░░░░░░░░░░]  14%  (12 / 86 sub-phases)
Stretch (P14-P16):  [░░░░░░░░░░░░░░░░░░░░]   0%  ( 0 /  8 sub-phases)
Combined:           [███░░░░░░░░░░░░░░░░░]  13%  (12 / 94 sub-phases)
```
...
| 2 | Admin section + Customer model             | `████░░░░░░` | 43% | 3/7 | 🚧 |
...
| 2  | Admin section + Customer model | 🚧 (3/7) | ✅ `/admin` route + widget-registry reuse · ✅ `PendingApprovalUsers` widget · ✅ `NotificationsModule` (Resend) + admin alert + customer welcome + approval-granted · ✅ `CustomerOrganization` + `CustomerContact` entities + demo-seed extension · cases FK to customer org · customer CRUD endpoints · frontend customer list/detail | [`docs/decisions/phase-02-admin-and-personalization.md`](docs/decisions/phase-02-admin-and-personalization.md) |
...
**Resolved architectural calls — P2.2 / P2.3 batch** (Pre-flights 5–11 + Mid-flights 4–5):
